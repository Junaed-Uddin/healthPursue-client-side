...
const ErrorPage = () => {
    ...
    return (
        <div>
            <section className="flex items-center sm:p-16 dark:bg-gray-900 dark:text-gray-100 h-screen">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-10  text-center sm:max-w-md">
